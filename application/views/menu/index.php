                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a class="badge badge-pill badge-success" href="" data-toggle="modal"
                                data-target="#Mymodal<?=$m['id']?>">
                                Edit</a>
                            <a class="badge badge-danger" href="<?=base_url('menu/qdelete/') . $m['id']?>">delete</a>
                        </td>
                    </tr>
                    <?php $i++;endforeach;?>
...
<div class="modal fade" id="Mymodal<?=$m['id'];?>" tabindex="-1" role="dialog" aria-labelledby="Mymodal<?=$m['id'];?>"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?=base_url('menu/qedit')?>" method="post">
                    <div class="form-group">
                        <input type="hidden" value='<?=$m['id']?>' class="form-control" id="kode" name='kode'
                            placeholder="Kode menu">
                        <input type="text" value='<?=$m['menu']?>' class="form-control" id="nama" name='nama'
